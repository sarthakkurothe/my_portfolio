...
export default function Hero({ }: Props) {
  const [text, count] = useTypewriter({
    words: [
      "Hey, Sarthak Kurothe here ;)",
      "I build things for the web apps.",
      "Designing interfaces, building robust backend.",
  ...
  return (
    <div className="pt-16 md:pt-28 h-screen flex flex-col space-y-8 items-center justify-center text-center overflow-hidden">
      ...
      <Image
        ...
        src="/extraImages/image.png"
        alt="sarthak kurothe profile image"
        priority={true}
      />
