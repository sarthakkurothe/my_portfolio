...
export default function Projects({ data }: Props) {
  ...
  const slideToPrev = () => {
    if (swiperInstance) {
      ...
      setIndexAt(swiperInstance.activeIndex);
    }
  };
    ...
    <div className="h-screen relative flex flex-col overflow-hidden text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0">
      ...
      <div className="relative w-full z-20">
        ...
        >
          {data.map((project, i) => (
            <SwiperSlide key={i}>
              <div className="w-screen flex-shrink-0 snap-center flex flex-col items-center justify-center p-10 md:p-44 h-screen mt-10 md:mt-28">
                <Image
                  width={400}
                  height={400}
